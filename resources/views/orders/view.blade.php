    ...
    <div class="col-sm-12">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <input type="hidden" name="lat" id="lat" value="{{ $order->customer()->first()->lat }}">
          <input type="hidden" name="lng" id="lng" value="{{ $order->customer()->first()->lng }}">
...
function initMap() {
  ...
  var map = new google.maps.Map(
      document.getElementById('map'), {zoom: 16, center: male});
